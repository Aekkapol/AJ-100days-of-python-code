...
# this is step byy step
for key, value in bites.items():
    if key not in exclude_bites:
        print(key, value)
# from above it comes up to dict comprehension below
{key: value for key, value in bites.items() if key not in exclude_bites}

# now just put it into function
